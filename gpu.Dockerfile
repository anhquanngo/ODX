...
# Verify OpenSfM in builder (fail fast before runtime stage)
RUN bash -c 'eval $(python3 /code/opendm/context.py) && python3 -c "from opensfm import io, pymap; print(\"OpenSfM import OK\")"'
